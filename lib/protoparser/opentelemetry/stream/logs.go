...
type StreamFn func([]string) (func(int64, []logstorage.Field), func())

// ParseLogsStream parses OpenTelemetry protobuf or json data from r and calls callback for the parsed rows.
func ParseLogsStream(r io.Reader, contentType string, isGzipped bool, getStream StreamFn) (int, error) {
...
func (wr *writeLogsContext) parseLogsRequest(req *pb.ExportLogsServiceRequest, getStream StreamFn) int {
	var count int
